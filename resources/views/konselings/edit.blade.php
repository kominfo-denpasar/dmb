@extends('layouts.app')
@section('page-title', 'Edit Konselings')
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('konselings.index') }}">Konselings</a></li>
    <li class="breadcrumb-item active">Edit Konselings</li>
@endsection
...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($konseling, ['route' => ['konselings.update', $konseling->id], 'method' => 'patch']) !!}
