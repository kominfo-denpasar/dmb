<div class="card-body p-0">
    <div class="table-responsive">
        <table class="table" id="konseling-masalahs-table">
            <thead>
            <tr>
            ...
            <tbody>
            @foreach($konselingMasalahs as $konselingMasalah)
                <tr>
    ...
    <div class="card-footer clearfix">
        <div class="float-right">
            @include('adminlte-templates::common.paginate', ['records' => $konselingMasalahs])
        </div>
    </div>
</div>
